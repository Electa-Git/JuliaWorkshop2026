...
function run_loop(tstart, tend, tstep, U_a, U_b, B, J, L_a, L_b, R_a, R_b, k)
    ω_vec = Float64[]
    i_a_vec = Float64[]
    i_b_vec = Float64[]
...
@benchmark run_loop(tstart, tend, tstep, U_a, U_b, B, J, L_a, L_b, R_a, R_b, k)
# (ω_vec, i_a_vec, i_b_vec) = run_loop( tstart, tend, tstep, U_a, U_b, B, J, L_a, L_b, R_a, R_b, k)
